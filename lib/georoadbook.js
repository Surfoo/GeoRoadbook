$().ready(function() {
    tinyMCE.init({
        ...
        elements: "editable",
        dialog_type: "modal",
        plugins: "fullpage,fullscreen,table,inlinepopups,print,preview,save,exportpdf,pagebreak,example",
        ...
        theme_advanced_buttons2: 'image,hr,removeformat,visualaid,|,sub,sup,charmap,pagebreak,|,tablecontrols,|,cleanup,code,fullpage,fullscreen,print,save,exportpdf,example',
        width: "210mm",
