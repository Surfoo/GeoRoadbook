...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="/js/tinymce/tinymce.min.js?{{ constant('SUFFIX_CSS_JS') }}"></script>
            ...
            <div class="hero-unit">
                ...
                <div id="ui_edition">
                    <div id="actions">
                        ...
                        <div class="btn-group">
                            <button type="submit" id="btn_save" class="btn btn-primary disabled" data-loading-text="Saving..." title="{{ last_modification|e }}">Save</button>
